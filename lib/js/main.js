...
class TicTacBoard {
    ...
    checkWin () { //checks for a win
        for(let i = 0; i < this.winArray.length; i++) {
            if(this.ticTacs[this.winArray[i][0]].div.style.backgroundColor === this.ticTacs[this.winArray[i][1]].div.style.backgroundColor && this.ticTacs[this.winArray[i][1]].div.style.backgroundColor === this.ticTacs[this.winArray[i][2]].div.style.backgroundColor) {
                this.indicateWin();
            }
        }
    }
